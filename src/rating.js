...
export default class Rating extends Component {
  ...
  renderRatings() {
    const { imageSize, ratingBackgroundColor, ratingCount, type } = this.props;
    const source = TYPES[type].source;

    return times(ratingCount, index =>
      <View key={index} style={styles.starContainer}>
        <Image source={source} style={{width: imageSize, height: imageSize, tintColor: ratingBackgroundColor}}/>
      </View>
    );
  }
